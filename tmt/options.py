...
def create_method_class(methods: MethodDictType) -> Type[click.Command]:
    ...
    class MethodCommand(click.Command):
        ...
        def _check_method(self, context: click.core.Context, args: List[str]) -> None:
            ...
            if how is not None:
                for method in methods:
                    if method.startswith(how):
                        self._method = methods[method]  # type: ignore
                        break
